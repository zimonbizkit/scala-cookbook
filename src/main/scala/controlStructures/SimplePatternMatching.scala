...
object SimplePatternMatching {
  def main(args: Array[String]): Unit = {
    ...
    println(echoWhatYouGaveMe(cDog("Suka")))
    ...
    println(echoWhatYouGaveMe(cDog("Fido")))
  ...
  def echoWhatYouGaveMe(x: Any): String = x match {
    ...
    case cDog("Suka") => "found a dog named Suka"
...
case class Person(s: String ,name:String)
